...
# >> 예약어를 사용해야 하는 경우 백틱(``)으로 묶어서 사용alter

# sql내에 올바른 이름 사용을 위해서는 의미있는 이름 사용
# : 그 내용을 명확하게 식별할 수 있도록 명명

# 테이블 명명규칙 : 명사 사용 권장 (복수형 명서를 사용)
# user >> users(members), product >> produts
...
# - 이름에 공백이나 특수 문자가 포함된 경우 식별을 위한 목적alter
