...
#! 인덱스의 종류
# 1. 클러스터형 인덱스 (ex. 영어사전, 국어사전) -- 바로 파악가능
# : 책의 내용이 이미 정렬되어 책 자체가 찾아보기 

# 2. 보조 인덱스 (ex. 일반 책의 찾아보기) -- 바로 파악 불가능
...
# show index의 결과 확인
# >> Key_name : col2, col3 (열 이름 지성 시 - 보조 인덱스)
# >> Non_unique : 고유 키도 중복 허용하지 X - 0 
...
insert into member values ('BLK', '블랙핑크', 9, '경남');
