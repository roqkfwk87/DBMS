...
-- insert into member
-- values ('BLACKPINK', '블랙핑크', 4, '서울', '001', '12341234', 155, '2020-10-10');
...
#! 인원 수의 2배를 하면 14명 이상이 되는 회원의 이름과 인원수 검사
select mem_name, mem_number
from member 
...
select table_namem, constraint_name
	from infomation_schema.referential_constraints
